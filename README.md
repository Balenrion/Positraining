...
- **Cardio** → dis d'abord ton **objectif** (récupération active, raffermir, perdre de la cellulite, améliorer le cardio, fractionné/HIIT, ou libre) : l'app te propose un type de séance et une durée adaptés (modifiables), avec des repères concrets (inclinaison, vitesse, résistance, coups/min…) **qui s'ajustent à la machine réellement choisie** — changer de machine (tapis, vélo, rameur, elliptique) recalcule immédiatement le repère, plutôt que de garder celui de la machine par défaut de l'objectif. Une fois la séance faite, indique le temps réel, et si tu veux, ton ressenti et une note libre (réglages utilisés…) — c'est enregistré et visible dans l'Agenda.
